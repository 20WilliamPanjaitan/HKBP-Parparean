                    ...
                    <div class="col-lg-6 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="course-item">
                            <form action="#" method="post">
                                ...
                                <div class="form-group mb-3">
                                    <label for="mail">Gereja Asal:</label>
                                    <input type="gereja_asal" class="form-control" id="mail" name="gereja_asal"
                                        placeholder="Gereja Asal" required />
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group mb-3">
                                                <label for="surat_referensi_gereja_asal" class="d-block">Upload Surat
                                                    Referensi Gereja
                                                    Asal:</label>
                                                <div class="input-group">
                                                    <input type="file" class="form-control-file"
                                                        id="surat_referensi_gereja_asal"
                                                        name="surat_referensi_gereja_asal" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
