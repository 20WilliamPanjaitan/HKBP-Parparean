    ...
    <main id="main">
        <section id="layanan" class="layanan section">
            <div class="container section-title" data-aos="fade-up">
                <h2>Layanan</h2>
                <p class="text1">Pendaftaran Pra-Nikah HKBP Parparean</p>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="course-item">
                            <form action="#" method="post">
                                ...
                                <div class="form-group mb-3">
                                    <label for="info">Info Anggota Keluarga Yang Akan Menikah & Pasangan:</label>
                                    <textarea class="form-control" id="info" name="info" rows="5"
                                        placeholder="(ex:RoyZeky Aritonang/Pria/30 Desember 2003 dengan Deboy Manalu/Wanita/1 Januari 1990)"
                                        required></textarea>
                                </div>
