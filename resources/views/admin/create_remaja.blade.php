    ...
    <div class="container-fluid">
        ...
        <div class="card shadow col-xl-10 col-md-6 mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Daftar Remaja</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.store.remaja') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="id_seksi" name="id_seksi" value="2">
                        </div>
                    </div>
