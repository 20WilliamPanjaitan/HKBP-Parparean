...
@section('title', 'Tambah Parompuan')
@section('side_bar')
<!-- Page Heading -->
<main>
    <div class="container-fluid">
        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href=parompuan>Daftar Parompuan</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    <a>Tambah Parompuan</a>
                </li>
            </ol>
        </nav>
        <!-- Basic Card Example -->
        <div class="card shadow col-xl-10 col-md-6 mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Daftar Parompuan</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.store.parompuan') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="id_seksi" name="id_seksi" value="4">
                        </div>
                    </div>
