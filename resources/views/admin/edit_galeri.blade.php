                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../galeri>Daftar Galeri</a> </li> <li class="breadcrumb-item active"
                                            aria-current="page">
                                            <a>Tambah Galeri</a>
                                </li>
                            </ol>
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tambah Daftar Galeri</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('galeri.update', $galeri->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="keterangan">{{ $galeri->keterangan }}</textarea>
                                        </div>
                                    </div>
