            ...
            <li class="nav-item">
                ...
                <div id="collapseBerita" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables_jadwal_ibadah.html">Jadwal Ibadah</a>
                        <a class="collapse-item" href="tables_tingting.html">Tingting</a>
                        <a class="collapse-item" href="acara">Acara</a>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" id="nama_acara" value="{{$acara->nama_acara}}"
