                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../acara>Daftar Acara</a> </li> <li class="breadcrumb-item active"
                                            aria-current="page">
                                            <a>Edit Acara</a>
                                </li>
                            </ol>
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Ubah Data Acara</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama_acara" name="nama_acara"
                                                value="{{$acara->nama_acara}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control " id="lokasi_acara"
                                                name="lokasi_acara" value="{{$acara->lokasi_acara}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jenis_acara" class="col-sm-2 col-form-label">Jenis Acara</label>
                                        <div class="col-sm-10">
                                            <select class="form-select form-control" id="jenis_acara" name="jenis_acara"
                                                autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control " id="keterangan" name="keterangan"
                                                value="{{$acara->keterangan}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
