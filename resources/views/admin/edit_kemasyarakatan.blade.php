...
<head>
    ...
    <title>Edit Kemasyarakatan</title>
                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../kemasyarakatan>Daftar Kemasyarakatan</a> </li> <li
                                            class="breadcrumb-item active" aria-current="page">
                                            <a>Tambah Kemasyarakatan</a>
                                </li>
                            </ol>
                        </nav>
                        <!-- Basic Card Example -->
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Kemasyarakatan</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('kemasyarakatan.update', $kemasyarakatan->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ $kemasyarakatan->nama }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
