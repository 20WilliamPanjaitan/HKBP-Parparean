    ...
    <div class="container-fluid">
        ...
        <div class="card shadow col-xl-10 col-md-6 mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Tata Ibadah</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('tata_ibadah.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row ">
                        <div class="col-sm-10">
                            <button type="submit" name="submit" id="submit" class="btn btn-success">Edit Tata Ibadah</button>
                        </div>
                    </div>
                </form>
            </div>
