...
<head>
    ...
    <title>Edit Sekolah Minggu</title>
                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../sekolah_minggu>Daftar Sekolah Minggu</a> </li> <li
                                            class="breadcrumb-item active" aria-current="page">
                                            <a>Tambah Sekolah Minggu</a>
                                </li>
                            </ol>
                        </nav>
                        <!-- Basic Card Example -->
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Sekolah Minggu</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('sekolah_minggu.update', $sekolah_minggu->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ $sekolah_minggu->nama }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
