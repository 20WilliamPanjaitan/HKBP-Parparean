                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Naposo</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('naposo.update', $naposo->id) }}" method="POST"
