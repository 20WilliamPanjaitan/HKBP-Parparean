                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../musik>Daftar Musik</a> </li> <li
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Musik</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('musik.update', $musik->id) }}" method="POST"
