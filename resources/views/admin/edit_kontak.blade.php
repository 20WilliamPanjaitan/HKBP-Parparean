                    ...
                    <div class="container-fluid">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../kontak>Daftar Kontak</a> </li> <li class="breadcrumb-item active"
                                            aria-current="page">
                                            <a>Tambah Kontak</a>
                                </li>
                            </ol>
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tambah Daftar Kontak</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="no_telepon" name="no_telepon"
                                                value="{{ $kontak->no_telepon }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
