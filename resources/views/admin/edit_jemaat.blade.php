    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item ">
                ...
                <div id="collapseBerita" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../berita">Berita</a>
                        <a class="collapse-item" href="../pengumuman">Pengumuman</a>
                        <a class="collapse-item" href="../acara">Acara & Kegiatan</a>
                    </div>
            </li>
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href=../index>Beranda </a> </li> <li class="breadcrumb-item">
                                        <a href=../jemaat_baru>Daftar Jemaat</a> </li> <li
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Jemaat</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('jemaat.update', $jemaat->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        <label for="nama_jemaat" class="col-sm-2 col-form-label">Nama</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama_jemaat" name="nama_jemaat"
                                                value="{{ $jemaat->nama_jemaat }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select form-control" id="jenis_kelamin" name="jenis_kelamin"
                                                ...
                                                <option value="Perempuan">Ketua</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                                value="{{ $jemaat->tempat_lahir }}" required>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="alamat" name="alamat"
                                                value="{{ $jemaat->alamat }}" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="kategori_jemaat" class="col-sm-2 col-form-label">Kategori</label>
                                        <div class="col-sm-10">
                                            <select class="form-select form-control" id="kategori_jemaat" name="kategori_jemaat"
                                                autofocus>
