        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-8" data-aos="fade-down">
                    <h3 class="fw-bold text-center mb-5">Dewan Marturia</h3>
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-7" data-aos="fade-left">
                    <ul class="data-aos" data-aos="fade-left" style="margin-top: 80px;">
                        <p>Pengurus Sending HKBP Parparean</p>
                        <li>St. Jontang Napitupulu</li>
                        <li>St. Arcenius Napitupulu</li>
                        <li>St. M. Siregar</li>
                    </ul>
                    <span>buat teks deskripsi</span>
                    </blockquote>
                </div>
