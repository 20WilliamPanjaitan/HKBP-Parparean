            ...
            <div class="row d-flex justify-content-between align-items-center">
                <div class="col-lg-5">
                    ...
                    <ul class="py-3 border-top border-dark" data-aos="fade-right">
                        <p><b>Pengurus Sending HKBP Parparean</b></p>
                    ...
                    <p data-aos="fade-right" data-aos-delay="200">
                        <p><b>Kegiatan Sending HKBP Parparean</b></p>
                        @foreach ($sending_kegiatan as $item)
        ...
        <div class="container">
            <div class="row d-flex justify-content-between align-items-center">
                ...
                <div class="col-lg-5">
                    <h3>Musik</h3>
                    <ul class="py-3 border-top border-dark" data-aos="fade-right">
                        <p><b>Pengurus musik HKBP Parparean</b></p>
                    ...
                    <p data-aos="fade-right" data-aos-delay="200">
                        <p><b>Kegiatan Musik HKBP Parparean</b></p>
                        @foreach ($musik_kegiatan as $item)
                        <li data-aos="fade-left" data-aos-delay="200">
                            {{$item->keterangan}}
                        </li>
                        @endforeach
